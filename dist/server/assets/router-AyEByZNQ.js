...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg bg-gradient-red p-2 shadow-red transition-transform group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "h-5 w-5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl tracking-wider font-bold", children: [
          "AMMAR ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col p-4 gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: l.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-surface/50 mt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center md:justify-between gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg bg-gradient-red p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "h-5 w-5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-lg tracking-wider font-bold", children: [
          "AMMAR ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "FITNESS" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: [Camera, Send, Video, Globe].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "#",
          "aria-label": "social",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 border-t border-border pt-6 text-center text-sm text-muted-foreground", children: [
      "Designed by Ahmed Yasser · © ",
      (/* @__PURE__ */ new Date()).getFullYear()
    ] })
  ] }) });
}
const appCss = "/assets/styles-5ckWpv6D.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-8xl font-bold text-gradient-red", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl font-bold", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "This page took a rest day. Get back to training." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold", children: "Something went wrong" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Try again or head back home." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-lg border border-border bg-surface px-5 py-2.5 text-sm font-semibold", children: "Home" })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$4 = () => import("./push-ZtiSSWNW.js");
const Route$4 = createFileRoute("/push")({
  head: () => ({
    meta: [{
      title: "Push Day — Chest, Shoulders & Triceps | Ahmed Fitness"
    }, {
      name: "description",
      content: "Push day workout: incline dumbbell press, chest press, shoulder press, lateral raises, tricep work with tutorial videos."
    }, {
      property: "og:title",
      content: "Push Day Workout"
    }, {
      property: "og:description",
      content: "Chest, shoulders, and triceps hypertrophy session."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./pull-DtTBr1Oj.js");
const Route$3 = createFileRoute("/pull")({
  head: () => ({
    meta: [{
      title: "Pull Day — Back, Rear Delts & Biceps | Ahmed Fitness"
    }, {
      name: "description",
      content: "Pull day workout: lat pulldown, seated row, Romanian deadlift, reverse flies, shrugs, hammer and dumbbell curls."
    }, {
      property: "og:title",
      content: "Pull Day Workout"
    }, {
      property: "og:description",
      content: "Back, rear delts, and biceps hypertrophy session."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./legs-C-BLfe5C.js");
const Route$2 = createFileRoute("/legs")({
  head: () => ({
    meta: [{
      title: "Legs Day — Quads, Hamstrings & Calves | Ahmed Fitness"
    }, {
      name: "description",
      content: "Legs day workout: hack squat, Romanian deadlift, leg press, hamstring curl, leg extension, adductors, calf raises."
    }, {
      property: "og:title",
      content: "Legs Day Workout"
    }, {
      property: "og:description",
      content: "Full lower body hypertrophy session."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-jpXlbpvm.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "About the Push Pull Legs program: principles, structure, and how to get the most from every session."
    }, {
      property: "og:title",
      content: "About Ahmed Fitness"
    }, {
      property: "og:description",
      content: "The principles behind the PPL hypertrophy split."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DPnRiRD8.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const PushRoute = Route$4.update({
  id: "/push",
  path: "/push",
  getParentRoute: () => Route$5
});
const PullRoute = Route$3.update({
  id: "/pull",
  path: "/pull",
  getParentRoute: () => Route$5
});
const LegsRoute = Route$2.update({
  id: "/legs",
  path: "/legs",
  getParentRoute: () => Route$5
});
